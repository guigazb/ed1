...
/* decrementar circularmente
Pre-condição: (o valor atual está entre 0 e maxItens)
Pos-condição: o decremento foi realizado */

int qinccirc(int atual,int max);
/* incrementa circularmente
Pre-condição: (o valor atual está entre 0 e maxItens)
Pos-condição: o incremento foi realizado */


//questao 4 prova 2023.1
int qremovelessthankey(Cqueue *cfila,void* key,int (*cmp)(void*,void*));
/* remove os elementos da fila até achar um menor que a chave
Pre-condição: (fila foi criada por cqCreate) && (existem itens na fila circular)
Pos-condição: os itens maiores ou iguais a chave foram removidos */

//questao 2 prova 2023.2 e questao 3 2021.2
int PromoveElementoFila(Cqueue *q, int n);
